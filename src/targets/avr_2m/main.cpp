...
void setup()
{
    ...
    stepperA.Setup(3, 2, counterA, 480e-6, 32000, -8000, 8000);
    delayMicroseconds(100);
    stepperB.Setup(5, 4, counterB, 480e-6, 32000, 0, 32000);

    Serial.println("I: Moving Speaker V1.0 by D\xC3\xA9tourner");
    Serial.print("I:");
